// Rebuilds icons/library.json (what the extension draws from) and
// icons/brands/<slug>.svg (one browsable file per logo, in its brand
...
const out = new URL('../icons/library.json', import.meta.url);
...
const brandsDir = new URL('../icons/brands/', import.meta.url);
...
console.log(`${icons.length} SVGs in icons/brands`);
